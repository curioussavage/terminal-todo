...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function formatedRows() {
      var rows = this.state.rows.map(function (row, index, list) {
      ...
      return colNames.slice(0, 2).map(function (colName, index) {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement('list', {
            ...
            width: '100%',
            height: '94%',
            onSelect: _this2.kanbanSelect.bind(_this2)
          })
        );
      });
    }
    ...
    key: 'kanbanSelect',
    value: function kanbanSelect(list, index) {
      //let item = list.getItem(index);
      //
    }
  }, {
    key: 'makeKanbanColumns',
    value: function makeKanbanColumns(todos) {
      var cols = {};
    ...
    value: function renderNormalMode(rows) {
      ...
      return _react2.default.createElement('listtable', {
        ...
        onSelect: function onSelect(tableNode, item) {
          _this3.setState({ selected: item - 1 });
        }
      });
    }
  }, {
    ...
    value: function render() {
      ...
      if (this.state.selected !== null) {
        var row = this.state.rows[this.state.selected];
...
function runGui(program) {
  ...
  var app = new _eventemitter.EventEmitter2();
  ...
  _db.Project.findOne({ where: { name: projectName } }).then(function (p) {
    p.getTodos().then(function (todos) {
      var app = (0, _reactBlessed.render)(_react2.default.createElement(App, { project: p, rows: todos }), screen);
